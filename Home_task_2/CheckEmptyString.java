...
public class CheckEmptyString {
    ...
    public static void processString() {
        try {
            System.out.println("Введена строка: " + processStringInternal(generateString()));
            int a = 10 / 0;
            ...
            System.out.printf("Нельзя вводить пустую строку", e.getMessage());
        }
        catch (Exception e){
    ...
    public static String processStringInternal(String str) throws MyEmptyStringException{
        if (str.isEmpty()){
...
class MyEmptyStringException extends MyException {
